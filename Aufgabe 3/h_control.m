...
function [h, nextStep] = h_control(h_alt, d, u0)
...
% Berechnung von h_min und h_max
% Achtung: u0 ist der größtmögliche Sprung am Eingang des PT1-Gliedes. Dies ist in diesem Fall die
% maximale Differenz des Ausgangs der Hysterese: delta_u = 2 (Sprung von
% z.B. -1 auf 1)
h_min = 6*Tm*e_ldf/u0;
h_max = 2*Tm;
